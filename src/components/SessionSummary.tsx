    ...
    >
      ...
      >
        ...
        <div className="text-center mb-6">
          <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-primary-500/20 flex items-center justify-center ring-1 ring-primary-500/10 animate-scale-in" aria-hidden="true">
        ...
        <div className="flex flex-col gap-2">
          <button
            ...
            className="w-full px-6 py-3.5 bg-primary-500 hover:bg-primary-600 text-white font-medium rounded-2xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 shadow-lg shadow-primary-500/20 min-h-[44px]"
          ...
          <button
            onClick={onDismiss}
            className="w-full px-6 py-3 bg-gray-800/80 hover:bg-gray-700 text-gray-300 font-medium rounded-2xl transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 min-h-[44px]"
